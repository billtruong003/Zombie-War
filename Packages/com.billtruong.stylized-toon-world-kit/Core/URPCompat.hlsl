...
// =============================================================================
//  TOON LIGHT RIG OVERRIDE
// -----------------------------------------------------------------------------
//  Global do game push (Shader.SetGlobalVector("_ToonLightDirection", -rig.forward)):
//  hướng TỚI nguồn sáng, cùng quy ước _MainLightPosition của directional light.
//  Khi được set (≠ 0) nó THAY hướng sáng của toon shading trên toàn kit — mọi
//  shader đều lấy light qua STW_GetMainLight nên override một chỗ ăn tất cả.
