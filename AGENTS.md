...
This project is indexed by GitNexus as **Zombie-War** (82 symbols, 78 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
