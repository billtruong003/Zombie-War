...
namespace ZombieWar.Editor
{
    ...
    public static class CasualCatalogGenerator
    {
        ...
        static List<ModularCostumeCatalog.SlotDefinition> BuildSlotDefinitions()
        {
            ...
            {
                Def("Eye",           "Mắt",        G, 1,  true,  false),
                Def("Brow",          "Lông mày",   G, 2,  true,  false),
                Def("Mouth",         "Miệng",      G, 3,  true,  false),
                Def("Hair",          "Tóc",        G, 4,  true,  false),
                Def("Beard",         "Râu",        G, 5,  false, true),
                Def("Mask",          "Mặt nạ",     G, 6,  false, true),
                Def("HairAccessory", "Phụ kiện tóc", G, 7, false, true),
                Def("Head",          "Mũ",         G, 8,  false, true),
                Def("Eyewear",       "Kính",       G, 9,  false, true),
                Def("Earring",       "Khuyên tai", G, 10, false, true),
                Def("Chest",         "Áo",         B, 12, true,  false),
                Def("Hands",         "Găng tay",   B, 13, false, true),
                Def("Bracelet",      "Vòng tay",   B, 14, false, true),
                Def("HandAccessory", "Phụ kiện tay", B, 15, false, true),
                Def("Watch",         "Đồng hồ",    B, 16, false, true),
                Def("Back",          "Ba lô",      B, 17, false, true),
                Def("Legs",          "Quần",       L, 18, true,  false),
                Def("Feet",          "Giày",       L, 19, false, true),
            };
            return list;
        }
