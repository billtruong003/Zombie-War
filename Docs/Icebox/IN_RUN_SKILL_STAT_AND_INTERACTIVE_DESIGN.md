...
> **SUPERSEDED / ICEBOX — 2026-08-08.** Đây là brainstorm lịch sử, không còn là hướng gameplay đã
> chốt. Source of truth hiện tại là
> [`../Reference/Design/SKILL_SYSTEM_DESIGN.md`](../Reference/Design/SKILL_SYSTEM_DESIGN.md) và
> [`../Reference/Design/COMBAT_GRAMMAR.md`](../Reference/Design/COMBAT_GRAMMAR.md). Hệ ba skill cố
> định, charge khi cất súng, năm level, XP Orb/Upgrade Core và các con số trong file này đều là ý
> tưởng bị hoãn; không được dùng để giao implementation task.
