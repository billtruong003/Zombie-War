...
> Canonical status as of 2026-07-21, after the verified Pro Casual commerce + weapon-upgrade milestone.
> Read this file before older handoffs. Older phase reports remain useful history, but several
> Fantasy-costume assumptions in them are obsolete.
