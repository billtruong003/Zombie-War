...
> Updated 2026-07-20, đối chiếu source 2026-07-31. Hướng dẫn lắp tay Phase 1/2 cũ đã lỗi thời;
> Player, weapon rig, weapon asset, UI prefab và scene đều đã authored. Đừng dựng lại bằng tay.

> ⚠️ **Hai điều cần biết trước khi mở editor** (chi tiết: `CURRENT_STATE.md` §3):
> - `Map_Level1..5.unity` hiện là file **binary**, không phải YAML. Mọi thao tác save 5 scene này
>   tạo diff không đọc được. Nếu định làm việc lâu dài trên map, cân nhắc chuyển chúng về text
>   serialization trước (cần owner duyệt).
> - Define `ZW_CHEATS` đang **bật** cho Android/iOS/Standalone. Tắt bằng menu `CheatBuildToggle`
>   trước bất kỳ build phát hành nào.
