...
> Updated 2026-07-21. Visual source: `UI_REDESIGN_SPEC.md`. Current status: `CURRENT_STATE.md`.
...
- **Campaign selector closed (Phase 1, 2026-08-08):** campaign selection is a compact,
  catalog-driven selector directly above Hub PLAY. It is not a separate five-node Campaign screen.
  Canonical behavior and unlock rules live in
  [`../Design/CAMPAIGN_AND_PROGRESSION.md`](../Design/CAMPAIGN_AND_PROGRESSION.md).
