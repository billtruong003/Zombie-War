...
> Doc này THAY THẾ `Deprecated/UIUX_WIREFRAME_PROMPT.md` (bản ASCII cũ đã lỗi thời — PLAY xanh + 5 tab là SAI,
...
> **Direction 02 correction (2026-07-23):** `Docs/Deprecated/UI_DIRECTION_02_HANDOFF.md` (deprecated, giữ làm design intent) is the
