...
> **SUPERSEDED IN PART — 2026-08-08.** Roster history và tuning axes trong file này vẫn là reference.
> Intended family identity và prototype rules hiện do [`COMBAT_GRAMMAR.md`](COMBAT_GRAMMAR.md) quyết
> định. Các fire mode, ammo economy, build tag, future weapon và roadmap dưới đây không phải
> implementation fact hoặc task authorization nếu chưa được source hiện hành xác nhận.
...
> economy vẫn là `[SPEC]` cho phase sau; xem `WeaponRosterMapping.json` và `CURRENT_STATE.md` cho trạng thái thật.
